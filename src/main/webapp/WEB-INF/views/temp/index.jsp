...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/fonts/flaticon/flaticon.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath}/resources/fonts/fontawesome/fontawesome-all.min.css" rel="stylesheet" type="text/css">
    <!-- Fav icons -->
    ...
    <!-- plugins CSS -->
    <link href="${pageContext.request.contextPath}/resources/css/plugins.css" rel="stylesheet">
    <!-- Colors CSS -->
    <link href="${pageContext.request.contextPath}/resources/styles/maincolors.css" rel="stylesheet">
    <!-- LayerSlider CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/vendor/layerslider/css/layerslider.css">
</head>
<!-- ==== body starts ==== -->
<body id="top">
<!-- Preloader -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="services-dropdown">
                                <a class="dropdown-item" href="../temp/services.html">Services Style 1</a>
                                <a class="dropdown-item" href="../temp/services2.html">Services Style 2</a>
                                <a class="dropdown-item" href="../temp/services-single.html">Services Single</a>
                            </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="about-dropdown">
                                <a class="dropdown-item" href="../temp/about.html">About Style 1</a>
                                <a class="dropdown-item" href="../temp/about2.html">About Style 2</a>
                            </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="adopt-dropdown">
                                <a class="dropdown-item" href="../temp/adoption.html">Adoption Gallery</a>
                                <a class="dropdown-item" href="../temp/adoption-single.html">Adoption Single Page</a>
                            </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="gallery-dropdown">
                                <a class="dropdown-item" href="../temp/gallery.html">Gallery Style 1</a>
                                <a class="dropdown-item" href="../temp/gallery2.html">Gallery Style 2</a>
                            </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="contact-dropdown">
                                <a class="dropdown-item" href="../temp/contact.html">Contact Style 1</a>
                                <a class="dropdown-item" href="../temp/contact2.html">Contact Style 2</a>
                            </div>
                        </li>
                        <!-- menu item -->
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="others-dropdown">
                                <a class="dropdown-item" href="../temp/team.html">Our Team</a>
                                <a class="dropdown-item" href="../temp/blog.html">Blog Home</a>
                                <a class="dropdown-item" href="../temp/blog-single.html">Blog Single</a>
                                <a class="dropdown-item" href="../temp/elements.html">Elements Page</a>
                                <a class="dropdown-item" href="../temp/404.html">404 Page</a>
                            </div>
                        </li>
                    </ul>
                    <!--/ul -->
...
<!-- /nav -->
<!-- ==== Slider ==== -->
<div id="slider" style="width:1200px;height:800px;margin:0 auto;margin-bottom: 0;">
    <!-- Slide 1 -->
    <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
        <!-- bg image  -->
        <img src="/resources/img/slide1.jpg" class="ls-bg" alt="" />
        <!-- text  -->
        <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
            <div class="header-text dog-elements">
                ...
                <div class="d-none d-sm-block">
                    ...
                    <a class="btn btn-primary " href="../temp/adoption.html">Adopt Today</a>
                </div>
                <!--/d-none  -->
            </div>
            <!-- header-text  -->
    ...
    <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
        <!-- bg image  -->
        <img src="/resources/img/slide2.jpg" class="ls-bg" alt="" />
        <!-- text  -->
        <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
            <div class="header-text cat-elements">
                ...
                <div class="d-none d-sm-block">
                    ...
                    <a class="btn btn-primary " href="../temp/contact.html">Contact us</a>
                </div>
                <!--/d-none  -->
            </div>
            <!-- header-text  -->
    ...
    <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
        <!-- bg image  -->
        <img src="/resources/img/slide3.jpg" class="ls-bg" alt="" />
        <!-- text  -->
        <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
            <div class="header-text dog-elements">
                ...
                <div class="d-none d-sm-block">
                    ...
                    <a class="btn btn-primary " href="../temp/services.html">Our services</a>
                </div>
                <!--/d-none  -->
            </div>
            <!-- header-text  -->
    ...
    <div class="ls-slide" data-ls="duration:4000; transition2d:7; kenburnszoom:out; kenburnsrotate:-5; kenburnsscale:1.2;">
        <!-- bg image  -->
        <img src="/resources/img/slide4.jpg" class="ls-bg" alt="" />
        <!-- text  -->
        <div class="ls-l header-wrapper" data-ls="offsetyin:150; durationin:700; delayin:200; easingin:easeOutQuint; rotatexin:20; scalexin:1.4; offsetyout:600; durationout:400; parallaxlevel:0;">
            <div class="header-text cat-elements">
                ...
                <div class="d-none d-sm-block">
                    ...
                    <a class="btn btn-primary " href="../temp/team.html">Our Team</a>
                </div>
                <!--/d-none  -->
            </div>
            <!-- header-text  -->
    ...
    <div class="container">
        ...
        <div class="container block-padding pt-0">
            <div class="row">
                ...
                <!-- /col-xl-->
                <div class="col-xl-6">
                    <img src="/resources/img/services2.jpg" alt=""   data-aos="fade-down"  data-aos-duration="1500"  class="img-fluid border-irregular1 border-double">
                </div>
            </div>
            <!-- /row -->
        </div>
                ...
                <div class="col-md-12">
                    <div class="serviceBox">
                        ...
                        <div class="service-content">
                            ...
                            <a class="btn btn-primary" href="../temp/services-single.html">read more</a>
                        </div>
                    </div>
                </div>
                <!-- service 2  -->
...
<section id="blurb" class="bg-primary text-light">
    <div class="container">
        <div class="row">
            <div class="col-xl-8">
                <!-- image  -->
                <img src="/resources/img/blurbimg.png" class="img-fluid blurb-img" alt="" />
            </div>
            <div class="col-xl-4" data-aos="fade-down" >
                <h2 class="res-margin">Join our club</h2>
                <p class="featured-text">Maecenas at arcu risus. Donec commodo sodales ex, scelerisque laoreet nibh hendrerit id.
                    In aliquet magna nec lobortis maximus. Etiam rhoncus leo a dolor placerat, nec elementum ipsum.
                </p>
                <!-- button -->
                <a href="../temp/contact.html" class="btn btn-primary">contact us</a>
            </div>
            <!-- /col-lg -->
        </div>
        <!-- /row -->
...
<section id="about" class="dog-bg2">
    ...
    <div class="container block-padding pt-0">
        <div class="row">
            ...
            <!-- image -->
            <div class="col-lg-6">
                <img src="/resources/img/about2.jpg" alt="" class="img-fluid border-irregular1"   data-aos="zoom-in">
            </div>
        </div>
        <!-- /row -->
    </div>
            ...
            <div id="owl-testimonial" class="owl-carousel owl-theme">
                ...
                <div class="testimonial">
                    ...
                    <div class="testimonial-pic">
                        <img src="/resources/img/team/team1.jpg" class="img-fluid" alt="">
                    </div>
                    <!-- /testimonial-pic -->
                ...
                <div class="testimonial">
                    ...
                    <!-- /content -->
                    <div class="testimonial-pic">
                        <img src="/resources/img/team/team2.jpg" class="img-fluid" alt="">
                    </div>
                    <!-- /testimonial-pic -->
                    <div class="testimonial-review">
                ...
                <div class="testimonial">
                    ...
                    <!-- /content -->
                    <div class="testimonial-pic">
                        <img src="/resources/img/team/team3.jpg" class="img-fluid" alt="">
                    </div>
                    <!-- /testimonial-pic -->
                    <div class="testimonial-review">
...
<section id="gallery" class="dog-bg1 bg-light pb-0">
    ...
    <div id="gallery-isotope" class="mt-5">
        ...
        <div class="dogscats col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery1.jpg" alt="">
                    <a href="/resources/img/gallery/gallery1.jpg"  title="You can add caption to pictures.">
        ...
        <div class="other col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery2.jpg" alt="">
                    <a href="/resources/img/gallery/gallery2.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="other col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery3.jpg" alt="">
                    <a href="/resources/img/gallery/gallery3.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="dogscats col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery4.jpg" alt="">
                    <a href="/resources/img/gallery/gallery4.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="dogscats col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery5.jpg" alt="">
                    <a href="/resources/img/gallery/gallery5.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="dogscats col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery6.jpg" alt="">
                    <a href="/resources/img/gallery/gallery6.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="dogscats col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery7.jpg" alt="">
                    <a href="/resources/img/gallery/gallery7.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="other col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery8.jpg" alt="">
                    <a href="/resources/img/gallery/gallery8.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="other col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery9.jpg" alt="">
                    <a href="/resources/img/gallery/gallery9.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="dogscats col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery10.jpg" alt="">
                    <a href="/resources/img/gallery/gallery10.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="other col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery11.jpg" alt="">
                    <a href="/resources/img/gallery/gallery11.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="dogscats col-lg-3 col-sm-6 col-md-6">
            <div class="isotope-item">
                <div class="gallery-thumb">
                    <img class="img-fluid" src="/resources/img/gallery/gallery12.jpg" alt="">
                    <a href="/resources/img/gallery/gallery12.jpg"  title="You can add caption to pictures.">
                        <span class="overlay-mask"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="container">
            <div id="owl-team2" class="owl-carousel owl-theme mt-5">
                ...
                <figure class="col-lg-12 team-style2">
                    <!-- image -->
                    <img src="/resources/img/team/team1.jpg" alt="" class="img-fluid"/>
                    <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                ...
                <figure class="col-lg-12 team-style2">
                    <!-- image -->
                    <img src="/resources/img/team/team2.jpg" alt="" class="img-fluid"/>
                    <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                            <a href="#"><i class="fa fa-envelope"></i></a>
                ...
                <figure class="col-lg-12 team-style2">
                    <!-- image -->
                    <img src="/resources/img/team/team3.jpg" alt="" class="img-fluid"/>
                    <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                            <a href="#"><i class="fa fa-envelope"></i></a>
                ...
                <figure class="col-lg-12 team-style2">
                    <!-- image -->
                    <img src="/resources/img/team/team4.jpg" alt="" class="img-fluid"/>
                    <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                            <a href="#"><i class="fa fa-envelope"></i></a>
                ...
                <figure class="col-lg-12 team-style2">
                    <!-- image -->
                    <img src="/resources/img/team/team5.jpg" alt="" class="img-fluid"/>
                    <figcaption>
                        <!-- social icons -->
                        <div class="icons">
                            <a href="#"><i class="fa fa-envelope"></i></a>
...
<section id="adopt" class="paws-house-bg1 bg-light">
    <div class="container ">
        ...
        <div class="row mt-5">
            ...
            <div class="adopt-card col-md-6 col-xl-3 res-margin">
                <div class="card bg-light-custom">
                    <div class="thumbnail text-center">
                        <!-- Image -->
                        <img src="/resources/img/adoption/adoption1.jpg" class="border-irregular1 img-fluid" alt="">
                        <!-- Name -->
                        <div class="caption-adoption">
                            ...
                            <div class="text-center">
                                <a href="../temp/adoption-single.html" class="btn btn-primary">More Info</a>
                            </div>
                        </div>
                    </div>
                    <!-- /thumbnail -->
            ...
            <div class="adopt-card col-md-6 col-xl-3 res-margin">
                <div class="card bg-light-custom">
                    <div class="thumbnail text-center">
                        <!-- Image -->
                        <img src="/resources/img/adoption/adoption2.jpg" class="border-irregular1 img-fluid" alt="">
                        <!-- Name -->
                        <div class="caption-adoption">
            ...
            <div class="adopt-card col-md-6 col-xl-3 res-margin">
                <div class="card bg-light-custom">
                    <div class="thumbnail text-center">
                        <!-- Image -->
                        <img src="/resources/img/adoption/adoption3.jpg" class="border-irregular1 img-fluid" alt="">
                        <!-- Name -->
                        <div class="caption-adoption">
            ...
            <div class="adopt-card col-md-6 col-xl-3 res-margin">
                <div class="card bg-light-custom">
                    <div class="thumbnail text-center">
                        <!-- Image -->
                        <img src="/resources/img/adoption/adoption4.jpg" class="border-irregular1 img-fluid" alt="">
                        <!-- Name -->
                        <div class="caption-adoption">
        ...
        <div class="text-center mt-5">
            <a href="../temp/adoption.html" class="btn btn-secondary btn-lg">See more pets</a>
        </div>
    </div>
    <!-- /container -->
</section>
...
<!-- GreenSock -->
<script src="/resources/vendor/layerslider/js/greensock.js"></script>
<!-- LayerSlider script files -->
<script src="/resources/vendor/layerslider/js/layerslider.transitions.js"></script>
<script src="/resources/vendor/layerslider/js/layerslider.kreaturamedia.jquery.js"></script>
<script src="/resources/vendor/layerslider/js/layerslider.load.js"></script>
<!-- Open Street maps -->
<script src="/resources/js/map.js"></script>
<!-- Mailchimp script -->
<script src="/resources/js/mailchimp.js"></script>
